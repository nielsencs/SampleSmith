...
The **Effective exported sample mapping** table shows which sample will play on which DecentSampler keys, including the key/root number used for each displayed SampleSmith note.
